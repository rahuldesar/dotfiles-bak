...
vim.keymap.set("n", "<leader>\\", "Nop", { noremap = true, silent = true, desc = "Split Vertical" })
vim.keymap.set("n", "<leader>\\", ":vsp<CR>", { noremap = true, silent = true, desc = "Split Vertical" })
vim.api.nvim_set_keymap("n", "<leader>so", ":source ~/.config/nvim/init.lua<CR>", { silent = true })
...
vim.keymap.set("n", "<leader><S-Tab>", ":bprevious<CR>", { noremap = true, silent = true })
